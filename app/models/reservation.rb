class Reservation < ApplicationRecord
  ...
  validate :number_of_guests_is_not_greater_than_capacity, if: -> {
    number_of_guests.present?
  }
  validate :chosen_date_is_available_for_reservation, if: -> {
    start_date.present? &&
    end_date.present? &&
    room_id.present?
  }
